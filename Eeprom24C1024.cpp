/**************************************************************************//**
 * \brief EEPROM 24C1024 library for Arduino
 * \author Copyright (C) 2012  Julien Le Sech - www.idreammicro.com
 * \version 1.0
 * \date 20120218
 *
 * This file is part of the EEPROM 24C1024 library for Arduino.
 *
...
/**************************************************************************//**
 * \fn Eeprom24C1024::Eeprom24C1024(byte deviceAddress)
 *
 * \brief Constructor.
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C1024::initialize()
 *
 ...
 ******************************************************************************/
void
Eeprom24C1024::initialize()
{
    Wire.begin();
}

/**************************************************************************//**
 * \fn void Eeprom24C1024::writeByte(
 * word address,
 * byte data)
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C1024::writeBytes(
 * word     address,
 * word     length,
 * byte*    p_data)
 *
...
/**************************************************************************//**
 * \fn byte Eeprom24C1024::readByte(word address)
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C1024::readBytes(
 * word     address,
 * word     length,
 * byte*    p_data)
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C1024::writePage(
 * word     address,
 * byte     length,
 * byte*    p_data)
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C1024::writeBuffer(
 * word     address,
 * byte     length,
 * byte*    p_data)
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C1024::readBuffer(
 * word     address,
 * byte     length,
 * byte*    p_data)
 *
