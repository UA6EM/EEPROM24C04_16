...
/**************************************************************************//**
 * \fn Eeprom24C32::Eeprom24C32(byte deviceAddress)
 *
 * \brief Constructor.
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C32::initialize()
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C32::writeBytes(
 * word     address,
 * word     length,
 * byte*    p_data)
 *
...
/**************************************************************************//**
 * \fn byte Eeprom24C32::readByte(word address)
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C32::writeBuffer(
 * word     address,
 * byte     length,
 * byte*    p_data)
 *
...
/**************************************************************************//**
 * \fn void Eeprom24C32::readBuffer(
 * word     address,
 * byte     length,
 * byte*    p_data)
 *
